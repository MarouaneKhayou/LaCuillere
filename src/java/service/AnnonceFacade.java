...
public class AnnonceFacade extends AbstractFacade<Annonce> {
    ...
    public int annulateAnnonce(Annonce annonce) {
        if (annonce.getStateAnnonce().equals("0")) {
            ...
            String req = "UPDATE Reservation R SET R.stateReservation= '-1', R.comment='Annonce annulée, merci de votre compréhension' WHERE R.annonceItem.annonce.id=" + annonce.getId();
